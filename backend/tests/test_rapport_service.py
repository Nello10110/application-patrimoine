...
def test_evolution_pct_entre_debut_et_fin_de_periode(db, monkeypatch):
    ...
    rapport = compute_rapport_periode(db, "2026-07-01", "2026-07-31")
...
def test_periode_annuelle_couvre_toute_lannee(db, monkeypatch):
    ...
    monkeypatch.setattr(
        historical_performance_service,
        "compute_portfolio_history",
        lambda db_: _points(("2025-12-15", 900.0), ("2026-06-01", 1100.0), ("2026-12-31", 1300.0)),
    )
    ...
    rapport = compute_rapport_periode(db, "2026-01-01", "2026-12-31")
...
def test_periode_personnalisee_arbitraire(db, monkeypatch):
    ...
    monkeypatch.setattr(
        historical_performance_service,
        "compute_portfolio_history",
        lambda db_: _points(("2026-03-10", 500.0), ("2026-04-10", 700.0)),
    )
    ...
    rapport = compute_rapport_periode(db, "2026-03-15", "2026-04-15")
