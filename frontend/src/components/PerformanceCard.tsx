    ...
    <Card title="Rentabilité globale">
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-1 text-xl font-semibold text-slate-900 dark:text-slate-100">{formatEuro(performance.valeur_totale, 0)}</p>
        </div>
        <div>
          ...
          <p className="mt-1 text-xl font-semibold text-slate-900 dark:text-slate-100">
            {formatEuro(performance.cout_total_investi, 0)}
          </p>
      ...
      <div className="mt-4 grid grid-cols-2 gap-4 border-t border-slate-100 pt-4 sm:grid-cols-3 lg:grid-cols-6 dark:border-slate-700">
        <div>
          ...
          <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{formatEuro(performance.dividendes_percus, 0)}</p>
        </div>
        <div>
          <p className="text-xs text-slate-500 dark:text-slate-400">Intérêts perçus (net)</p>
          <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{formatEuro(performance.interets_percus, 0)}</p>
        </div>
        <div>
          <p className="text-xs text-slate-500 dark:text-slate-400">Autres revenus</p>
          <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{formatEuro(performance.autres_revenus, 0)}</p>
        </div>
        <div>
          <p className="text-xs text-slate-500 dark:text-slate-400">Frais payés</p>
          <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{formatEuro(performance.frais_payes, 0)}</p>
        </div>
        <div>
          <p className="text-xs text-slate-500 dark:text-slate-400">Impôts prélevés</p>
          <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{formatEuro(performance.impots_preleves, 0)}</p>
        </div>
        <div>
          <p className="text-xs text-slate-500 dark:text-slate-400">Gains réalisés (ventes)</p>
          <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{formatEuro(performance.gains_realises, 0)}</p>
        </div>
      </div>
    </Card>
  )
